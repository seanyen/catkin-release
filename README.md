...
## catkin (noetic) - 0.8.10-1

The packages in the `catkin` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic catkin` on `Thu, 22 Apr 2021 15:08:23 -0000`
...
## catkin (kinetic) - 0.7.29-1

The packages in the `catkin` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -r kinetic -t kinetic catkin` on `Wed, 14 Oct 2020 16:15:14 -0000`
...
## catkin (melodic) - 0.7.29-1

The packages in the `catkin` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin` on `Wed, 14 Oct 2020 16:14:00 -0000`
...
- upstream repository: git@github.com:ros/catkin.git
- release repository: https://github.com/ros-gbp/catkin-release.git
- rosdistro version: `0.7.28-1`
- old version: `0.7.28-1`
- new version: `0.7.29-1`
...
## catkin (noetic) - 0.8.9-1

The packages in the `catkin` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic catkin` on `Wed, 14 Oct 2020 16:12:42 -0000`
...
## catkin (melodic) - 0.7.28-1

The packages in the `catkin` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin` on `Fri, 24 Jul 2020 16:34:43 -0000`
...
- upstream repository: git@github.com:ros/catkin.git
- release repository: https://github.com/ros-gbp/catkin-release.git
- rosdistro version: `0.7.26-1`
- old version: `0.7.27-1`
- new version: `0.7.28-1`
...
## catkin (noetic) - 0.8.8-1

The packages in the `catkin` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic catkin` on `Fri, 24 Jul 2020 16:18:04 -0000`
...
## catkin (melodic) - 0.7.27-1

The packages in the `catkin` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin` on `Tue, 14 Jul 2020 17:40:19 -0000`
...
- release repository: https://github.com/ros-gbp/catkin-release.git
- rosdistro version: `0.7.26-1`
- old version: `0.7.26-1`
- new version: `0.7.27-1`
...
## catkin (noetic) - 0.8.7-1

The packages in the `catkin` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic catkin` on `Tue, 14 Jul 2020 17:35:54 -0000`
...
## catkin (noetic) - 0.8.6-1

The packages in the `catkin` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic catkin` on `Fri, 29 May 2020 04:41:24 -0000`
...
## catkin (melodic) - 0.7.26-1

The packages in the `catkin` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin` on `Thu, 21 May 2020 17:58:10 -0000`
...
- old version: `0.7.25-1`
- new version: `0.7.26-1`
...
## catkin (noetic) - 0.8.5-1

The packages in the `catkin` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic catkin` on `Thu, 21 May 2020 17:55:56 -0000`
...
## catkin (melodic) - 0.7.25-1

The packages in the `catkin` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic catkin` on `Thu, 14 May 2020 18:29:59 -0000`
...
- release repository: https://github.com/ros-gbp/catkin-release.git
- rosdistro version: `0.7.23-1`
- old version: `0.7.24-1`
- new version: `0.7.25-1`
...
The packages in the `catkin` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -r lunar -t lunar catkin` on `Thu, 27 Jul 2017 14:01:33 -0000`
...
The packages in the `catkin` repository were released into the `hydro` distro by running `/usr/bin/bloom-release -r hydro -t hydro catkin` on `Mon, 16 Jun 2014 19:29:23 -0000`
